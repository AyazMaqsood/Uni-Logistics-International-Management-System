...
export default function AdminNewShipment2() {
  return (
    <div className="container mt-4">
      ...
      <form className="mt-4">
        ...
        <div className="mb-3">
          ...
          <input type="text" className="form-control" placeholder="Enter packaging type" />
        </div>
      </form>
      <div className="text-end">
        <Link to="/admin" className="btn btn-dark">Next</Link>
      </div>
    </div>
  );
}
